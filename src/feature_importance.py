...
#homemade
from inverse_utils import     DoInverseDesign_SaveCSV,     draw_target_spectrum_from_low_high_ranges,     plot_spectral_target_VS_spectral_predicted_using_InverseDesignFeatures
...
#sclar_or_spectral_ = ['scalar', 'spectral']
sclar_or_spectral_ = ['spectral']
...
if feature_importance_permutation:
    ...
    #%% load ML models for the inverse design
    for sclar_or_spectral in sclar_or_spectral_:
        # this is the folder that contains all the variables
        ...
        for DT_or_DTGEN in DT_or_DTGEN__:
            ...
            # feature importance using the impurity ------------------
            if DT_or_DTGEN == 'DTGEN':                
                estimator_here = dt_gen                
                X_train_here = X_new_train
                y_train_here = y_new_train
            ...
            if estimator_here != []:
                Au_feature_importances, SiO_feature_importances, SiN_feature_importances = \
                    feature_importance_by_material(estimator_here, X_train_here, y_train_here) # using Charles code for separating material
                
                # saving
                savefolder = InverseDesignModels_folder_here
                filename_mat = 'feature_importance_'+DT_or_DTGEN
                matlab_save_filename = savefolder+filename_mat+'.mat'

                feature_name_here = list(X_train_here.columns)
                print(feature_name_here)
                print(type(feature_name_here))

                dict_to_save = {}
                variable_name_list = ['Au_feature_importances', 'SiO_feature_importances', 'SiN_feature_importances', 'feature_name_here']
                ...
                scipy.io.savemat(matlab_save_filename, dict_to_save)
                print(matlab_save_filename)
